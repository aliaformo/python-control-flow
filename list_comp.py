...
titled_cities = [city.title() for city in cities]
print(titled_cities) # ['New York City', 'Mountain View', 'Chicago', 'Los Angeles', 'Houston']

squares = [x**2 for x in range(9)]
print(squares) # [0, 1, 4, 9, 16, 25, 36, 49, 64]

# Adding conditionals to list comprehension

# Squares to just even numbers (only if)
even_squares = [x**2 for x in range(1,16) if x%2 == 0]
print(even_squares) # [4, 16, 36, 64, 100, 144, 196]

# Adding if else conditionals to list comprehension

else_even_squares = [ x**2 if x % 2 == 0 else x+5 for x in range(3,10) ]
print(else_even_squares) # [8, 16, 10, 36, 12, 64, 14]
...
for year, winner_list in winners.items():
    for winner in winner_list:
        if winner not in win_count_dict:  # win_count_dict[winner] = win_count_dict.get(winner, 0) + 1
...
print(highest_count) # 4
print(most_win_director)  # ['John Ford']